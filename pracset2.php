...
function sortWordFrequencies(&$wordFrequencies, $sortingOrder) {
    if ($sortingOrder === 'asc') {
...
function displayWordFrequencies($wordFrequencies, $displayLimit) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $filteredWords = filterStopWords($words, $stopWords);
    $wordFrequencies = calculateWordFrequencies($filteredWords);
    sortWordFrequencies($wordFrequencies, $sortingOrder);
    displayWordFrequencies($wordFrequencies, $displayLimit);
}
?>
<!DOCTYPE html>
<html>
